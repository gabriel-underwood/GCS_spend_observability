   ...
   private final String testBucketName = "charged-atlas-465220-v8-example-bucket-1";
    ...
    void testCollectMetrics() {
        ...
        try {
            ...
            // If you have no buckets or it's been less than 24 hours since you created the buckets, there are no metrics
            // See https://docs.cloud.google.com/monitoring/api/metrics_gcp_p_z#gcp-storage
            // "This value is measured once per day, and there might be a delay after measuring before the value becomes available in Cloud Monitoring."
            if (!metrics.isEmpty()) {
